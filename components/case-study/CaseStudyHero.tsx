...
function FinTechMockup() {
  return (
    <svg width="100%" height="280" viewBox="0 0 800 280" fill="none" aria-hidden="true" style={{ maxWidth: "800px" }}>
      ...
      <rect x="16" y="52" width="120" height="6" rx="3" fill="rgba(255,107,74,0.25)" />
      ...
      <rect x="192" y="36" width="60" height="24" rx="4" fill="rgba(255,107,74,0.15)" />
      <rect x="264" y="36" width="60" height="24" rx="4" fill="rgba(52,211,153,0.15)" />
      <rect x="336" y="36" width="60" height="24" rx="4" fill="rgba(251,113,133,0.15)" />
      <polyline points="192,110 232,90 272,100 312,70 352,80 392,60 432,70 472,50" stroke="#22D3EE" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
...
function HealthcareMockup() {
  return (
    <svg width="100%" height="280" viewBox="0 0 800 280" fill="none" aria-hidden="true" style={{ maxWidth: "800px" }}>
      ...
      <circle cx="60" cy="50" r="28" fill="rgba(255,107,74,0.15)" />
      ...
      <polyline points="296,100 326,80 356,90 386,60 416,70 446,50 476,60 506,40" stroke="#34D399" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <rect x="566" y="40" width="218" height="60" rx="4" fill="rgba(255,107,74,0.08)" />
      <polyline points="576,80 606,65 636,72 666,50 696,58 726,45 756,52 776,38" stroke="#22D3EE" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="566" y="120" width="218" height="60" rx="4" fill="rgba(52,211,153,0.08)" />
      <polyline points="576,160 606,150 636,155 666,140 696,145 726,135 756,140 776,130" stroke="#34D399" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="566" y="200" width="218" height="60" rx="4" fill="rgba(251,113,133,0.08)" />
      <polyline points="576,240 606,230 636,235 666,220 696,225 726,215 756,220 776,210" stroke="#FB7185" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function SaaSMockup() {
  return (
    <svg width="100%" height="280" viewBox="0 0 800 280" fill="none" aria-hidden="true" style={{ maxWidth: "800px" }}>
      ...
      <text x="286" y="56" fill="#34D399" fontSize="22" fontWeight="700">99.99%</text>
      ...
      <text x="556" y="56" fill="#FB7185" fontSize="22" fontWeight="700">45ms</text>
      ...
      <rect x="16" y="146" width="358" height="8" rx="4" fill="rgba(255,107,74,0.2)" />
      <rect x="16" y="162" width="300" height="8" rx="4" fill="rgba(255,107,74,0.15)" />
      <rect x="16" y="178" width="340" height="8" rx="4" fill="rgba(255,107,74,0.18)" />
      <rect x="16" y="194" width="280" height="8" rx="4" fill="rgba(255,107,74,0.12)" />
      <rect x="16" y="210" width="320" height="8" rx="4" fill="rgba(255,107,74,0.15)" />
      <rect x="16" y="226" width="260" height="8" rx="4" fill="rgba(255,107,74,0.1)" />
      <rect x="16" y="242" width="290" height="8" rx="4" fill="rgba(255,107,74,0.12)" />
      <rect x="16" y="258" width="240" height="8" rx="4" fill="rgba(255,107,74,0.08)" />
      ...
      <polyline points="430,260 460,240 490,250 520,220 550,230 580,200 610,210 640,180 670,190 700,170 730,180 760,160 790,170" stroke="#22D3EE" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="790" cy="170" r="4" fill="#22D3EE" />
    </svg>
  );
}
...
function LogisticsMockup() {
  return (
    <svg width="100%" height="280" viewBox="0 0 800 280" fill="none" aria-hidden="true" style={{ maxWidth: "800px" }}>
      ...
      {/* Vehicle dots */}
      <circle cx="160" cy="100" r="5" fill="#34D399" />
      ...
      {/* Route lines */}
      <polyline points="160,100 220,130 260,150 300,150" stroke="rgba(52,211,153,0.4)" strokeWidth="2" fill="none" strokeDasharray="4 4" />
      ...
      <text x="560" y="56" fill="#34D399" fontSize="22" fontWeight="700">312</text>
...
function EdTechMockup() {
  return (
    <svg width="100%" height="280" viewBox="0 0 800 280" fill="none" aria-hidden="true" style={{ maxWidth: "800px" }}>
      ...
      <rect x="296" y="88" width="100" height="28" rx="6" fill="rgba(255,107,74,0.15)" />
      ...
      <rect x="566" y="44" width="80" height="60" rx="4" fill="rgba(255,107,74,0.08)" />
      <rect x="580" y="80" width="52" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
      <rect x="658" y="44" width="80" height="60" rx="4" fill="rgba(52,211,153,0.08)" />
...
function HaenKomputerMockup() {
  return (
    <svg width="100%" height="280" viewBox="0 0 800 280" fill="none" aria-hidden="true" style={{ maxWidth: "800px" }}>
      ...
      <rect x="16" y="36" width="108" height="6" rx="3" fill="rgba(52,211,153,0.2)" />
      ...
      <rect x="16" y="156" width="108" height="6" rx="3" fill="rgba(255,107,74,0.2)" />
      ...
      {/* Metric cards */}
      <rect x="172" y="36" width="96" height="70" rx="6" fill="rgba(52,211,153,0.1)" stroke="rgba(52,211,153,0.2)" />
      ...
      <rect x="280" y="36" width="96" height="70" rx="6" fill="rgba(255,107,74,0.1)" stroke="rgba(255,107,74,0.2)" />
      ...
      <rect x="388" y="36" width="96" height="70" rx="6" fill="rgba(251,113,133,0.1)" stroke="rgba(251,113,133,0.2)" />
      ...
      <rect x="172" y="188" width="408" height="6" rx="3" fill="rgba(255,107,74,0.18)" />
      ...
      <circle cx="706" cy="80" r="48" fill="none" stroke="rgba(52,211,153,0.15)" strokeWidth="10" />
      <circle cx="706" cy="80" r="48" fill="none" stroke="rgba(52,211,153,0.6)" strokeWidth="10" strokeDasharray="200 302" strokeLinecap="round" transform="rotate(-90 706 80)" />
      ...
      <rect x="628" y="164" width="140" height="6" rx="3" fill="rgba(52,211,153,0.2)" />
      <rect x="628" y="180" width="130" height="6" rx="3" fill="rgba(255,107,74,0.2)" />
      <rect x="628" y="196" width="120" height="6" rx="3" fill="rgba(251,113,133,0.15)" />
      <rect x="628" y="220" width="156" height="30" rx="6" fill="rgba(52,211,153,0.15)" />
