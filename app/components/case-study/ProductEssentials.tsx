...
function ProductUIMockup({ type }: { type: string }) {
  if (type === "microservices") {
    return (
      <svg width="100%" height="320" viewBox="0 0 900 320" fill="none" aria-hidden="true" style={{ maxWidth: "900px", margin: "0 auto", display: "block" }}>
        ...
        <rect x="16" y="40" width="248" height="8" rx="4" fill="rgba(79,110,247,0.2)" />
        ...
        <polyline points="316,280 356,240 396,260 436,220 476,240 516,200 556,220" stroke="#60a5fa" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <rect x="616" y="44" width="268" height="40" rx="6" fill="rgba(16,185,129,0.1)" stroke="rgba(16,185,129,0.2)" />
        ...
        <rect x="616" y="156" width="268" height="40" rx="6" fill="rgba(167,139,250,0.1)" stroke="rgba(167,139,250,0.2)" />
        <rect x="630" y="172" width="120" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
        <rect x="616" y="212" width="268" height="40" rx="6" fill="rgba(96,165,250,0.1)" stroke="rgba(96,165,250,0.2)" />
  ...
  if (type === "data-platform") {
    return (
      <svg width="100%" height="320" viewBox="0 0 900 320" fill="none" aria-hidden="true" style={{ maxWidth: "900px", margin: "0 auto", display: "block" }}>
        ...
        <rect x="16" y="44" width="408" height="8" rx="4" fill="rgba(79,110,247,0.2)" />
        ...
        <polyline points="488,280 528,250 568,270 608,230 648,250 688,210 728,230 768,200 808,220 848,190 888,210" stroke="#10b981" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
  ...
  if (type === "cloud-scale") {
    return (
      <svg width="100%" height="320" viewBox="0 0 900 320" fill="none" aria-hidden="true" style={{ maxWidth: "900px", margin: "0 auto", display: "block" }}>
        ...
        <rect x="16" y="44" width="868" height="8" rx="4" fill="rgba(79,110,247,0.2)" />
  ...
  if (type === "checkout-flow") {
    return (
      <svg width="100%" height="320" viewBox="0 0 900 320" fill="none" aria-hidden="true" style={{ maxWidth: "900px", margin: "0 auto", display: "block" }}>
        ...
        <rect x="224" y="44" width="452" height="8" rx="4" fill="rgba(79,110,247,0.2)" />
        ...
        <rect x="224" y="242" width="452" height="50" rx="6" fill="rgba(16,185,129,0.1)" stroke="rgba(16,185,129,0.2)" />
  ...
  if (type === "iot-dashboard") {
    return (
      <svg width="100%" height="320" viewBox="0 0 900 320" fill="none" aria-hidden="true" style={{ maxWidth: "900px", margin: "0 auto", display: "block" }}>
        ...
        <circle cx="340" cy="180" r="6" fill="#10b981" />
        <circle cx="500" cy="100" r="6" fill="#febc2e" />
        <circle cx="220" cy="240" r="6" fill="#10b981" />
        <circle cx="380" cy="250" r="6" fill="#ff5f57" />
        <polyline points="180,110 220,130 290,150 340,180" stroke="rgba(16,185,129,0.4)" strokeWidth="2" fill="none" strokeDasharray="4 4" />
        ...
        <rect x="620" y="44" width="264" height="40" rx="6" fill="rgba(16,185,129,0.1)" stroke="rgba(16,185,129,0.2)" />
        ...
        <rect x="620" y="214" width="264" height="40" rx="6" fill="rgba(79,110,247,0.1)" stroke="rgba(79,110,247,0.2)" />
        <rect x="634" y="230" width="120" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
        <rect x="620" y="270" width="264" height="40" rx="6" fill="rgba(96,165,250,0.1)" stroke="rgba(96,165,250,0.2)" />
  ...
  return (
    <svg width="100%" height="320" viewBox="0 0 900 320" fill="none" aria-hidden="true" style={{ maxWidth: "900px", margin: "0 auto", display: "block" }}>
      <rect x="0" y="0" width="280" height="320" rx="8" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.06)" />
      <rect x="16" y="16" width="120" height="8" rx="4" fill="rgba(255,255,255,0.12)" />
      <rect x="16" y="44" width="248" height="8" rx="4" fill="rgba(79,110,247,0.2)" />
      ...
      <rect x="316" y="240" width="248" height="60" rx="6" fill="rgba(16,185,129,0.1)" stroke="rgba(16,185,129,0.2)" />
      ...
      <rect x="616" y="44" width="268" height="40" rx="6" fill="rgba(79,110,247,0.1)" stroke="rgba(79,110,247,0.2)" />
      <rect x="630" y="60" width="120" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
      <rect x="616" y="100" width="268" height="40" rx="6" fill="rgba(16,185,129,0.1)" stroke="rgba(16,185,129,0.2)" />
      <rect x="630" y="116" width="120" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
      <rect x="616" y="156" width="268" height="40" rx="6" fill="rgba(254,188,46,0.1)" stroke="rgba(254,188,46,0.2)" />
      <rect x="630" y="172" width="120" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
      <rect x="616" y="212" width="268" height="40" rx="6" fill="rgba(96,165,250,0.1)" stroke="rgba(96,165,250,0.2)" />
      <rect x="630" y="228" width="120" height="6" rx="3" fill="rgba(255,255,255,0.1)" />
      <rect x="616" y="268" width="268" height="40" rx="6" fill="rgba(167,139,250,0.1)" stroke="rgba(167,139,250,0.2)" />
