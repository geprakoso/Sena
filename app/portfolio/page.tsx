...
export const metadata: Metadata = {
  ...
  description:
    "Explore SolveCore's portfolio of real-world software projects — from FinTech platform modernization to SaaS scaling, each delivering measurable business impact.",
  openGraph: {
    title: "Portfolio — SolveCore",
    description:
      "Real problems. Real impact. Browse our portfolio of custom software projects across FinTech, Healthcare, SaaS, Logistics and more.",
    type: "website",
    locale: "en_US",
  },
  twitter: {
