...
const TAG_GRADIENTS: Record<string, string> = {
  ...
  EdTech: "linear-gradient(135deg, #2a1a3a 0%, #4a0e5a 100%)",
};
    ...
    >
        ...
        >
          ...
          <div
            style={{
              ...
              height: "180px",
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(79,110,247,0.22) 0%, transparent 70%)",
              top: "50%",
              left: "50%",
      ...
      <style>{`
        .portfolio-card:hover {
          ...
          box-shadow: 0 12px 40px rgba(0,0,0,0.3), 0 0 0 1px rgba(79,110,247,0.1) !important;
        }
...
function ProjectIllustration({ id }: { id: string }) {
  ...
  if (id === "healthcare") {
    return (
      <svg width="130" height="88" viewBox="0 0 130 88" fill="none" aria-hidden="true">
        ...
        <path d="M65 28V60M49 44H81" stroke="#60a5fa" strokeWidth="3.5" strokeLinecap="round" />
        <circle cx="65" cy="44" r="20" fill="none" stroke="rgba(96,165,250,0.18)" />
        <circle cx="65" cy="44" r="10" fill="none" stroke="rgba(96,165,250,0.12)" />
        <circle cx="96" cy="20" r="9" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.09)" />
        <path d="M96 14V26M90 20H102" stroke="#a78bfa" strokeWidth="1.6" strokeLinecap="round" />
      </svg>
    );
  }
  if (id === "saas") {
    return (
      <svg width="130" height="88" viewBox="0 0 130 88" fill="none" aria-hidden="true">
        <circle cx="65" cy="44" r="24" fill="rgba(167,139,250,0.1)" stroke="rgba(167,139,250,0.18)" />
        <circle cx="65" cy="44" r="15" fill="rgba(167,139,250,0.08)" stroke="rgba(167,139,250,0.12)" />
        <circle cx="65" cy="44" r="7" fill="rgba(167,139,250,0.28)" />
        <ellipse cx="65" cy="44" rx="24" ry="9" fill="none" stroke="rgba(167,139,250,0.14)" strokeWidth="1" />
        <circle cx="89" cy="44" r="3.5" fill="#a78bfa" />
        <circle cx="41" cy="44" r="2.5" fill="rgba(167,139,250,0.45)" />
        ...
        <line x1="39" y1="26" x2="52" y2="36" stroke="rgba(167,139,250,0.28)" strokeWidth="1" />
        <line x1="78" y1="52" x2="91" y2="61" stroke="rgba(167,139,250,0.28)" strokeWidth="1" />
      </svg>
    );
  }
  if (id === "ecommerce") {
    return (
      <svg width="130" height="88" viewBox="0 0 130 88" fill="none" aria-hidden="true">
        ...
        <rect x="28" y="30" width="36" height="26" rx="4" fill="rgba(16,185,129,0.12)" stroke="rgba(16,185,129,0.2)" />
        ...
        <rect x="70" y="52" width="34" height="8" rx="3" fill="rgba(16,185,129,0.18)" />
        <circle cx="46" cy="43" r="10" fill="rgba(16,185,129,0.15)" stroke="rgba(16,185,129,0.25)" />
        <path d="M40 43l4 4 8-8" stroke="#10b981" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  if (id === "logistics") {
  ...
  return (
    <svg width="130" height="88" viewBox="0 0 130 88" fill="none" aria-hidden="true">
      ...
      <rect x="26" y="36" width="60" height="3" rx="1.5" fill="rgba(167,139,250,0.4)" />
      ...
      <circle cx="100" cy="56" r="16" fill="rgba(167,139,250,0.1)" stroke="rgba(167,139,250,0.2)" />
      <path d="M94 56h12M100 50v12" stroke="#a78bfa" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
