...
const file = 'app/data/content.ts';
let code = fs.readFileSync(file, 'utf8');

// Replace export const CASE_STUDY_DETAILS: CaseStudyDetail[] = [
// with export const getCaseStudyDetails = (dict: any = {}): CaseStudyDetail[] => [
code = code.replace('export const CASE_STUDY_DETAILS: CaseStudyDetail[] = [', 'export const getCaseStudyDetails = (dict: any = {}): CaseStudyDetail[] => [\n  {');

// Add translation mapping for haen-komputer
code = code.replace(
`    id: "haen-komputer",
    slug: "haen-komputer",
