...
export const getServices = (dict: Record<string, any>): Service[] => [
  {
    id: "custom-software",
    icon: "code",
    title: dict?.services_section?.custom_software_title || "Pengembangan Software Custom",
    description: dict?.services_section?.custom_software_desc || "Kami membangun aplikasi web dan mobile yang disesuaikan dengan alur kerja bisnis Anda.",
    href: "/#services",
  },
  {
    id: "problem-solving",
    icon: "puzzle",
    title: dict?.services_section?.problem_solving_title || "Digitalisasi Operasional Bisnis",
    description: dict?.services_section?.problem_solving_desc || "Kami membantu mengurangi proses manual dan pekerjaan berulang melalui sistem yang lebih terintegrasi.",
    href: "/#services",
  },
  {
    id: "cloud-devops",
    icon: "cloud",
    title: dict?.services_section?.cloud_devops_title || "Infrastruktur & Skalabilitas Sistem",
    description: dict?.services_section?.cloud_devops_desc || "Kami memastikan aplikasi berjalan stabil, aman dan siap berkembang seiring pertumbuhan bisnis Anda.",
    href: "/#services",
  },
  {
    id: "product-development",
    icon: "chart",
    title: dict?.services_section?.product_development_title || "MVP & Pengembangan Berkelanjutan",
    description: dict?.services_section?.product_development_desc || "Kami membantu membangun MVP cepat dan mengembangkan produk secara bertahap sesuai kebutuhan bisnis.",
    href: "/#services",
  },
];
...
export const getApproachSteps = (dict: Record<string, any>): ApproachStep[] => [
  {
    number: "1",
    label: dict?.approach_section?.discover_label || "Analisis Kebutuhan",
    description: dict?.approach_section?.discover_desc || "Kami mempelajari alur kerja, hambatan operasional, dan kebutuhan bisnis Anda sebelum pengembangan dimulai.",
    icon: "search",
  },
  {
    number: "2",
    label: dict?.approach_section?.define_label || "Perancangan Solusi",
    description: dict?.approach_section?.define_desc || "Kami menyusun alur sistem dan fitur yang paling sesuai dengan kebutuhan operasional bisnis Anda.",
    icon: "lightbulb",
  },
  {
    number: "3",
    label: dict?.approach_section?.develop_label || "Pengembangan Sistem",
    description: dict?.approach_section?.develop_desc || "Kami membangun software yang stabil, mudah digunakan, dan siap mendukung operasional bisnis Anda.",
    icon: "code2",
  },
  {
    number: "4",
    label: dict?.approach_section?.deliver_label || "Implementasi dan Pengembangan",
    description: dict?.approach_section?.deliver_desc || "Kami membantu proses implementasi dan terus melakukan pengembangan agar sistem tetap relevan seiring pertumbuhan bisnis Anda.",
    icon: "rocket",
  },
];
